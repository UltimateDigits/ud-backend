import { getInfraClient } from '../chunk-RHQVMRQ7.js';
import { estimateSize } from '../chunk-NAMYS2KV.js';
import { mainLogger } from '../chunk-76CTSAYR.js';
import { MAX_ROOM_METADATA_SIZE } from '../chunk-WMLTOCXJ.js';
...
var API = class {
  ...
  createRoom = async (data) => {
    try {
      ...
      if (data?.metadata && estimateSize(data.metadata) > MAX_ROOM_METADATA_SIZE) {
